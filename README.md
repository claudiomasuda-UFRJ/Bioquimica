...
•	Alternativa correta destacada em verde; comentário pedagógico após cada questão
•	Ordem aleatória opcional
•	Atalhos de teclado para navegação fluida

📚 Conteúdo abordado
Parte	Tema
Parte 1	Fontes de energia biológica
Parte 2	Bioenergética e termodinâmica biológica
Parte 3	Fosforilação Oxidativa (OXPHOS)
Parte 4	Ciclo de Krebs
Parte 5	Glicólise
...
Recursos:
•	14 vias metabólicas com 5 pistas cada, da mais abstrata à mais direta
•	Placar ao vivo para até 4 equipes, editável durante o jogo
•	Seletor de vias: escolha quais incluir em cada sessão
•	Sistema de pontuação decrescente (1ª pista = 5 pts → 5ª pista = 1 pt)
•	Atalhos de teclado e suporte a tela cheia
...
1.	Abra o link da ferramenta no navegador e conecte ao projetor
